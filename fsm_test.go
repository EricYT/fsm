...
func TestGenericCallbacks(t *testing.T) {
	...
	fsm := NewFSM(
		...
		Callbacks{
			"before_event": func(e *Event) error {
				beforeEvent = true
				return nil
			},
			"leave_state": func(e *Event) error {
				leaveState = true
				return nil
			},
			"enter_state": func(e *Event) error {
				enterState = true
				return nil
			},
			"after_event": func(e *Event) error {
				afterEvent = true
				return nil
			},
		},
...
func TestSpecificCallbacks(t *testing.T) {
	...
	fsm := NewFSM(
		...
		Callbacks{
			"before_run": func(e *Event) error {
				beforeEvent = true
				return nil
			},
			"leave_start": func(e *Event) error {
				leaveState = true
				return nil
			},
			"enter_end": func(e *Event) error {
				enterState = true
				return nil
			},
			"after_run": func(e *Event) error {
				afterEvent = true
				return nil
			},
		},
...
func TestSpecificCallbacksShortform(t *testing.T) {
	...
	fsm := NewFSM(
		...
		Callbacks{
			"end": func(e *Event) error {
				enterState = true
				return nil
			},
			"run": func(e *Event) error {
				afterEvent = true
				return nil
			},
		},
...
func ExampleNewFSM() {
	fsm := NewFSM(
		...
		Callbacks{
			"before_warn": func(e *Event) error {
			...
			"leave_green": func(e *Event) error {
			...
			"enter_yellow": func(e *Event) error {
...
func ExampleFSM_Transition() {
	fsm := NewFSM(
		...
		Callbacks{
			"leave_closed": func(e *Event) error {
				e.Async()
				return nil
			},
		},
